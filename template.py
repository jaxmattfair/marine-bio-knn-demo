...
def train_knn(X_train, y_train, k=3):
    ...
    pass # DELETE THIS ONCE YOU'VE WRITTEN YOUR CODE
    # ========================


def test_knn(knn, X_test, y_test):
    # ========================
    # GET THE SCORE OF YOUR MODEL
    # Hint: Use knn.score()
...
def plot_decision_boundaries(X, y, knn, dataset_name, feature_labels, num_dimensions=2, class_names=None):
    ...
    if num_dimensions == 1:
        ...
        # For 3D, scatter plot with color coding
        fig = plt.figure()
...
def plot_test_decisions(X, y, knn, dataset_name, feature_labels, num_dimensions=2):
    ...
    # Plot correct and incorrect classifications
...
if __name__ == '__main__':
    # Load data
    iris = load_iris()
    num_dim = # Fill in the number of dimensions
    num_neighbors = # Fill in the number of dimensions
